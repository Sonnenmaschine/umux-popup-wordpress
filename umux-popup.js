(function () {
  function initializeUMUXPopup() {
    ...
    const defaultConfig = {
      ...
      cssUrl:
        "https://cdn.jsdelivr.net/gh/StabiBerlin/umux-popup/umux-popup.css", // URL zur externen CSS-Datei
    };
    ...
    if (!config.surveyUrl) {
      console.error(
        'Bitte die "surveyUrl" im UMUXConfig-Objekt konfigurieren.'
      );
      return;
    }
  ...
  function createPopup(config) {
    ...
    trigger.innerHTML = `
        <span class="av-icon-char" aria-hidden="true" data-av_icon="h" data-av_iconfont="fa-comment" style="font-size: 1.4em; margin-right: 0.4em;"></span>
